"""Single-seed RGB quick-B0 DFormerv2-S training configuration."""
...
C.run_id = "museg-dformerv2-s-rgb-quick-b0-v1"
...
C.mst = False
C.sliding = False
C.log_dir = osp.join(_OUTPUT_ROOT, "museg-dformerv2-s-rgb-quick-b0-v1", "development", "seed-772961337")
